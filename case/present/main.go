...
var (
	...
	usePlayground = flag.Bool("use_playground", true, "run code snippets using play.golang.org; if false, run them locally and deliver results by WebSocket transport")
